<div class="page-title">
  <div class="title_left">
    <h3>FORM PEMBAYARAN - <?php echo $invoice ?></h3>
  </div>
              ...
              <table class='table table-bordered'>       
                ...
                <tr>
                	<td colspan="2">
                		<table>
                			<tr>
                				<td><?php echo $nama_item.' ('.$nama_type.'-'.$nama_merek.'/'.$tahun_buat.')' ?></td><td>Rp.<?php echo $nama_item ?></td>
                			</tr>
                		</table>
                	</td>
                </tr>
                ...
                <tr id="step7" hidden>
                  <td width='200'>Price Sale <?php echo form_error('total_price_sale') ?></td><td><input type="text" class="form-control" name="total_price_sale" id="total_price_sale" placeholder="Price Sale" value="<?php echo $total_price_sale; ?>" /></td>
                </tr>
                <tr id="step8" hidden>
                  <td width='200'>Biaya Admin <?php echo form_error('biaya_admin') ?></td><td><input type="text" class="form-control" name="biaya_admin" id="biaya_admin" placeholder="Biaya Admin" value="<?php echo $admin_fee->nominal ?>" /></td>
                </tr>
                <tr id="step9" hidden>
          ...
          if (durasicicilan > 0) {
            ...
            $('#step4').html(`
                <td colspan="2" align="center">
                  ...
                  <a class="btn btn-primary" href="<?php echo base_url() ?>onetimep/paymentform?invoice=${invoice}&idp=${pelanggan_id}&buy=${item_id}&st=Cash&d=${moment().toISOString()}&user_id=${user_id}"><i class="fa fa-card"></i>Lanjut Pembayaran</a>
