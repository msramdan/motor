...
// let's make cell with wrap text but not break into the next rows or someshit
function vcell($c_width,$c_height,$x_axis,$text){
	...
	if($len>7){
		$w_text=str_split($text,50);// splits the text into length of anything i want (for exanmple, because this is the longest field, i set it to 40) and saves in a array since we need wrap cell of two cell we took $w_text[0], $w_text[1] alone.
