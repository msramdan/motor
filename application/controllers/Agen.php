...
class Agen extends CI_Controller
{
    ...
    public function create_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data = array(
		'nama_agan' => $this->input->post('nama_agan',TRUE),
    ...
    public function update($id) 
    {
		...
		'nama_agan' => set_value('nama_agan', $row->nama_agan),
    ...
    {
	$this->form_validation->set_rules('nama_agan', 'nama agan', 'trim|required');
	...
	xlsWriteLabel($tablehead, $kolomhead++, "Nama Agan");
	...
	foreach ($this->Agen_model->get_all() as $data) {
	    ...
	    xlsWriteLabel($tablebody, $kolombody++, $data->nama_agan);
